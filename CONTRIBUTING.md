...
- Confirm the change is consistent with the reference implementation (the ~~Agentomatic~~ Agentimus plugin). The specification describes **real, shipped behavior**, not aspiration.
